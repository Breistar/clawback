...
export function PageHeader({ title }: { title: string }) {
  ...
  return (
    <div className="mb-6 flex items-center justify-between">
      ...
      <button className="tap relative flex h-9 w-9 items-center justify-center rounded-full border border-[var(--color-line)] bg-[var(--color-paper-raised)] text-slate-500">
